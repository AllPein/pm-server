...
import 'package:pm_server/src/business/user_images.dart';
import 'package:pm_server/src/business/users.dart';
import 'package:pm_server/src/generated/protocol.dart';
import 'package:pm_server/src/util/random_string.dart';
...
class Emails {
  ...
  static Future<UserInfo?> createUser(
    ...
    final hash = generatePasswordHash(password, email);
    var auth = EmailAuth(
      userId: userInfo.id!,
      email: email,
      hash: hash,
